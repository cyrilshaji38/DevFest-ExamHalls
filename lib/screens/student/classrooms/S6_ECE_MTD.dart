...
class MTD extends StatefulWidget {
  const MTD({Key key}) : super(key: key);

  @override
  _MTDState createState() => _MTDState();
}

class _MTDState extends State<MTD> {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(children: <Widget>[
          Text("S6-ECE: Microwave Theory and Techniques",textScaleFactor: 2.5, textAlign: TextAlign.center,),
          Text("\n"),
          Row(children:<Widget>[
            Text("\t\t\t\t\t\t"),
